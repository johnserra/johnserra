...
**Dedicated Supabase project.** CareerTalkLab runs on its own Supabase instance, fully independent from the portfolio site. This gives the LMS its own auth user pool, independent migrations, and clean billing separation.
