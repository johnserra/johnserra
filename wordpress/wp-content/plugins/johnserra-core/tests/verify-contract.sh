...
rg -q "rest_.*_collection_params" "$plugin_dir/includes/class-translations.php"
rg -q "filter_collection_by_locale" "$plugin_dir/includes/class-translations.php"
rg -q "js_legacy_source_key" "$plugin_dir/includes/class-translations.php"
...
rg -q "wp_after_insert_post" "$plugin_dir/includes/class-webhook.php"
rg -q "hash_hmac" "$plugin_dir/includes/class-webhook.php"
rg -q "X-JohnSerra-Signature" "$plugin_dir/includes/class-webhook.php"
